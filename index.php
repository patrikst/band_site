...
//	$titleImage = "../common/images/icons/heo_icon.png";
	...
	//	uly_print_lyrics_table($debug, $dbase, $tableName, $targetPHP, "uID", $stateFlag, $edituID, $title, $artist, $category, $language);
		$mode = "ADD";
		ucssr_print_header_title("L�gg till l�t...");
...
//		ulyr_view_lyric_head($debug, $dbase, $tableName, $songID, $targetPHP, $theKey, $fontSize, $mode, $bandID, $errorFlag, $title, $artist, $category, $language, $PREVIOUS_ACTION, $bChords);
	...
	else if ($action2 == "do_add_lyrics")
	{
		...
		ubdc_print_page_title("L�gger till l�t. ", "", "", "", $bandID);
		$db 	= "Lyrics";
		$table 	= "new_lyrics";
...
//		up_hr();
	...
	else if ($action == "view_all_lyrics" || $action == "")
	{
		...
		ucssr_print_header_title("Alla l�tar");
		ucss_section_start($debug, "lyricListSection", "clearfix");
//	 	uly_print_lyrics_table($debug, $dbase, $tableName, $targetPHP, $uniqueKeyLabelName, $stateFlag, $edituID, $givenTitle, $givenArtist, $givenCategory, $givenLanguage, $titleFilter, $artistFilter, $instrumentFilter, $bandID, $importFlag, $anchorPoint, $highLightSongID, $PREVIOUS_ACTION );
	...
	{
//		ubdc_print_page_title("L�tar", "", "", "", $bandID);
		$PREVIOUS_ACTION = ubdc_create_previous_action($MY_PHP_PARAM_LIST, $PHP_FILE_NAME);
		ucssr_print_header_title("L�tar - N�sta rep");
...
//		ubdc_print_page_title("L�tar", "", "", "", $bandID);
		$PREVIOUS_ACTION = ubdc_create_previous_action($MY_PHP_PARAM_LIST, $PHP_FILE_NAME);
		ucssr_print_header_title("F�rslagna l�tar");
		ucss_section_start($debug, "lyricListSection", $class);
...
//		ubdc_print_page_title("L�tar", "", "", "", $bandID);
		$PREVIOUS_ACTION = ubdc_create_previous_action($MY_PHP_PARAM_LIST, $PHP_FILE_NAME);
		ucssr_print_header_title("Inrepade l�tar");
		ucss_section_start($debug, "lyricListSection", $class);
	 	ulyr_print_lyrics_table_by_lyrics_status($debug, $dbase, $tableName, $targetPHP, "uID", "", $edituID, $givenTitle, $givenArtist, $givenCategory, $givenLanguage, 0, $titleFilter, $artistFilter, $instrument, $bandID, $highlightID, $PREVIOUS_ACTION);
		ucss_section_end($debug, "lyricListSection", $class);
	}
...
//		ubdc_print_page_title("L�tar", "", "", "", $bandID);
		$PREVIOUS_ACTION = ubdc_create_previous_action($MY_PHP_PARAM_LIST, $PHP_FILE_NAME);
	// 	uly_print_lyrics_table_by_lyrics_status($debug, $dbase, $tableName, $targetPHP, "uID", "", $edituID, $givenTitle, $givenArtist, $givenCategory, $givenLanguage, 0, $titleFilter, $artistFilter, $instrument, $bandID, $highlightID, $PREVIOUS_ACTION);
		ucssr_print_header_title("Reslutat s�kning");
		ucss_section_start($debug, "lyricListSection", "clearfix");
//	 	uly_print_lyrics_table($debug, $dbase, $tableName, $targetPHP, $uniqueKeyLabelName, $stateFlag, $edituID, $givenTitle, $givenArtist, $givenCategory, $givenLanguage, $titleFilter, $artistFilter, $instrumentFilter, $bandID, $importFlag, $anchorPoint, $highLightSongID, $PREVIOUS_ACTION );
	 	ulyr_print_lyrics_table_by_lyrics_status($debug, $dbase, $tableName, $targetPHP, "uID", "", $edituID, $givenTitle, $givenArtist, $givenCategory, $givenLanguage, "", $titleFilter, $artistFilter, $instrument, $bandID, $highlightID, $PREVIOUS_ACTION);
		ucss_section_end($debug, "lyricListSection", $class);
		ucssr_print_header_title("Relaterade l�tar att importera...");
		ucss_section_start($debug, "lyricListSection", "clearfix");
	...
	{
//		ubdc_print_page_title("Importera l�t", "", "", "", $bandID);
		ucssr_print_header_title("Importera l�t...");
		ucss_section_start($debug, "lyricListSection", "clearfix");
		uly_print_import_table($debug, $MainDb, $tableName , $targetPHP, $uniqueKeyLabelName, $stateFlag, $edituID, $givenTitle, $givenArtist, $givenCategory, $givenLanguage, $titleFilter, $artistFilter, $instrumentFilter, $genreFilter, $bandID, 1 );
		ucss_section_end($debug, "lyricListSection", $class);
	}
	...
	{
//		ubdc_print_page_title("Filtrerade importl�tar", "", "", "", $bandID);
		ucssr_print_header_title("Importera l�t (filter)...");
		ucss_section_start($debug, "lyricListSection", "clearfix");
		uly_print_import_table($debug, $MainDb, $tableName , $targetPHP, $uniqueKeyLabelName, $stateFlag, $edituID, $givenTitle, $givenArtist, $givenCategory, $givenLanguage, $titleFilter, $artistFilter, $instrumentFilter, $genreFilter, $bandID, 1 );
		ucss_section_end($debug, "lyricListSection", $class);
...
// 	if($debug) echo "<h1>$bandName</h1><hr>";
	...
	{
		// ubdc_print_page_title("S�kning", "", "", "", $bandID, "SEARCH", $PHP_FILE_NAME);
...
//  ubdc_print_page_title($pageTitle, $subTitle, $addURL, $addHoverText, $bandID)
			ubdc_print_page_title("Gamla L�tlistor", "", "", "", $bandID);
		//	$debug = 1;
	...
	else if ($action == "view_repertoirs")  // ALL
	{
		//	$debug = 1;
		if ($debug) echo "<li> VIEW ALL REPERTOIRS - debug=$debug";
		ucssr_print_header_title("L�TLISTOR");
		ucss_section_start($debug, "section3", $class);
	    ubd_rp_view($debug,  $bandID, "", $PHP_FILE_NAME, $LYRICS_PHP);	  // VIEW ALL  
	    ub_nice_link("$targetPHP?action=view_old_repertoirs&bandID=$bandID", "Gamla l�tlistor");
		ucss_section_end();
		if ($debug) echo "<li> VIEW ALL REPERTOIRS...DONE";
	}
	...
	{
			ubdc_print_page_title("L�tlistor", "", "$PHP_FILE_NAME?action=print_add_repertoir_form&bandID=$bandID", "", $bandID);
			//$debug = 1;
	...
	{	
			ubdc_print_page_title("L�tlistor", "", "", "", $bandID);
		//	$debug = 1;
		//	if  ($long_document == "" && )
	   //    		ubd_rp_print_add_pdf_form($debug, $bandID, $rID, $targetPHP ); 
	    //   	else
	...
	{	
		...
		ucssr_print_header_title("Redigera l�tlista - $name");
		ucss_section_start($debug, "section3", $class);	
	...
	{	
			$name = ubd_rp_get_repertoir_name($debug, $bandID, $rID);
			ubdc_print_page_title("L�tlistor", $name, "$PHP_FILE_NAME?action=print_add_repertoir_form&bandID=$bandID", "", $bandID);
			//$debug=1;
	...
	{	
		//ubdc_print_page_title("Kopiera l�tlista", "", "", "", $bandID);
		ucssr_print_header_title("Kopiera l�tlista");
		ucss_section_start($debug, "section3", $class);	
...
// BEFORE		ubdc_print_page_title("Kopierad l�tlista - $repertoir_name", "", "", "", $bandID);
...
//		ubd_rp_print_nice_repertoir($debug, $bandID, $NewrID, $layout, $chordLayout, $userID, $HideIcons, $bandMgmtPHP, $lyricsPHP);
	...
	{	
			$name = ubd_rp_get_repertoir_name($debug, $bandID, $rID);
			ubdc_print_page_title("L�tlistor", $name, "", "", $bandID);  // $PHP_FILE_NAME?action=print_add_repertoir_form&bandID=$bandID
		//	$debug=1;
...
//	    ubd_rp_view($debug,  $bandID,  $repertoirID, $PHP_FILE_NAME, $LYRICS_PHP, $layout, $PREVIOUS_ACTION);	  // VIEW SPECIFIC  
	...
	{
		ucssr_print_header_title("Ta bort l�tlista");
		ucss_section_start($debug, "section3", $class);	
...
//		ubdc_print_page_title("Rep", "Kommande rep", "$PHP_FILE_NAME?action=print_add_rehersal_form&bandID=$bandID", "Add rehersal", $bandID);
		...
		ucss_section_end($debug, "section3", $class);	
		ucssr_print_header_title("TILLG�NGLIGHETSSCHEMA");
		ucss_section_start($debug, "section3", $class);	
		ubd_rh_print_availability_matrix($debug, $targetPHP, $bandID, $userID, 30, $goto);
		ucss_section_end($debug);
//	 	ub_nice_link("$targetPHP?action=print_rehersal_availability&bandID=$bandID", "Tillg�nglighetsschema", $target, "Fyll i n�r du kan repa!", $tableColumn, $onMouseOver, $onMouseOut, $fontSize, $bold, $italic, $valign, $columnWidth, $colspan, $openColumn, $bgcolor, $fontColor);
...
//			ubdc_print_page_title("Rep", "L�gg till rep", $addURL, $addHoverText, $bandID);
		//$debug = 1;
...
//		ubdc_print_page_title("Rep", "Kommande rep", "$PHP_FILE_NAME?action=print_add_rehersal_form&bandID=$bandID", "Add rehersal", $bandID);
	...
	// ======================================
	// TILLG�NGLIGHET / AVAILABILITY
	else if ($action == "print_rehersal_availability")
	{
		// ubdc_print_page_title("Tillg�nglighetsschema", "", "", "L�gg till", $bandID);
		$debug = 0;
		if ($debug) up_note ("VIEW REHERSALS");
	 	// ubd_rh_view($debug, $bandID,  $rehersalID, $PHP_FILE_NAME, $LYRICS_PHP);	
	    ucssr_print_header_title("TILLG�NGLIGHETSSCHEMA");
	...
	{
		ubdc_print_page_title("L�gg till spelning", "", "$PHP_FILE_NAME?action=print_add_gig_form&bandID=$bandID", "L�gg till spelning...", $bandID);
	...
	{
		ubdc_print_page_title("L�gg till arena", "", "$PHP_FILE_NAME?action=print_add_gig_form&bandID=$bandID", "L�gg till spelning...", $bandID);
		// $debug = 1;
...
/* NOT USED */
	...
	{
		ubdc_print_page_title("Redigera arena", "", "$PHP_FILE_NAME?action=print_add_gig_form&bandID=$bandID", "L�gg till spelning...", $bandID);
		// $debug = 1;
		ubdc_print_new_arena_item_form($targetPHP, $errorFlag, $arenaID, $bandID, $gigID);
	}
	else if ($action == "update_arena")
	{
		ubdc_print_page_title("Uppdatera arena", "", "$PHP_FILE_NAME?action=print_add_gig_form&bandID=$bandID", "L�gg till spelning...", $bandID);
		// $debug = 1;
	...
	{	
//		ubdc_print_page_title("L�gger till spelning", "", "$PHP_FILE_NAME?action=print_add_gig_form&bandID=$bandID", "L�gg till spelning...", $bandID);
		// $debug = 1;
...
//	    	ubd_gi_print_form($debug, $bandID, 0, "", $date, $time, $notes, $arenaID, $PHP_FILE_NAME, "ERROR");
	...
	{
//		ubdc_print_page_title("Spelningar", "", "$PHP_FILE_NAME?action=print_add_gig_form&bandID=$bandID", "L�gg till spelning...", $bandID);
		// $debug = 1;
...
//			ubdc_print_page_title($eventType, "", "", "L�gg till spelning...", $bandID);			
			// ubdc_print_page_title("Spelning", "", "$PHP_FILE_NAME?action=print_add_gig_form&bandID=$bandID", "L�gg till spelning...", $bandID);
...
/*
		if ($eventType != "")
			...
			ubdc_print_page_title("L�gg till spelning", "", "", "", $bandID);
*/
		//$debug = 1;
...
//		ubdc_print_page_title("Spelning", "", "$PHP_FILE_NAME?action=print_add_gig_form&bandID=$bandID", "L�gg till spelning...", $bandID);
	...
	{
		ubdc_print_page_title("L�gg till bandmedlem", "", "", "", $bandID);
	    ubd_bm_print_form($debug, $bandID, $edit, $bandMemberID, $targetPHP);
	}
	else if ($action == "add_bandmember")
	{	
	//	ubdc_print_page_title("L�gg till bandmedlem", "", "$PHP_FILE_NAME?action=print_add_bandmember_form&bandID=$bandID", "L�gg till bandmedlem...", $bandID);
	//	$debug = 1;
	...
	else if ($action == "view_bandmember")
	{
		...
		// ubdc_print_page_title("Bandmedlem", "", "$PHP_FILE_NAME?action=print_add_bandmember_form&bandID=$bandID", "L�gg till bandmedlem...", $bandID);
		// ubd_bm_view($debug,  $bandMemberID);	    
	}
	else if ($action == "edit_bandmember")
	{
		ubdc_print_page_title("Redigera Bandmedlem", "", "$PHP_FILE_NAME?action=print_add_bandmember_form&bandID=$bandID", "L�gg till bandmedlem...", $bandID);
		//ubd_bm_view($debug,  $bandMemberID);	
	...
	else if ($action == "delete_band_member")
	{
		...
		ubdc_print_page_title("Ta bort bandmedlem '$firstName $lastName'", "", "$PHP_FILE_NAME?action=print_add_bandmember_form&bandID=$bandID", "L�gg till bandmedlem...", $bandID);
	...
	{
		//ubdc_print_page_title("L�gg till video", "", "$PHP_FILE_NAME?action=view_band_videos&bandID=$bandID", "Avbryt", $bandID, "CANCEL");
		ucss_section_start($debug, "section3", $class);
	...
	{	
		ubdc_print_page_title("L�gg till video", "", "$PHP_FILE_NAME?action=print_add_video_form&bandID=$bandID", "L�gg till video...", $bandID);
	...
	{
	//	ubdc_print_page_title("View Video", "", "$PHP_FILE_NAME?action=print_add_band_video_form&bandID=$bandID", "L�gg till video...", $bandID);
	//	$debug = 1;
	//	ubd_vi_view_all($debug, $bandID, $targetPHP);
		ucss_section_start($debug, "section3", $class);
	...
	{
	//	ubdc_print_page_title("Videos", "", "$PHP_FILE_NAME?action=print_add_band_video_form&bandID=$bandID", "L�gg till video...", $bandID);
	//	$debug = 1;
	...
	{
		ubdc_print_page_title("Ok�nt val", "", "", "", $bandID);
